//create carts with functional oop

function Cart(localStorageStoreVariable = "cart-oop") {
  const cart = {
    //1st
    cartItems: undefined,
    ...
    loadFromStorage() {
      this.cartItems = JSON.parse(
        localStorage.getItem(localStorageStoreVariable)
      ) || [
        // FIRST ITEM
        {
...
const cartoon = Cart(); // returns default passed in val // just for test

cartoon.loadFromStorage();
